...
export default function DocumentDetailClient({ id, initialData }: { id: string; initialData: DocumentResponse }) {
  const router = useRouter();
  const [data, setData] = useState<DocumentResponse | null>(initialData);
