...
export default async function DashboardPage() {
  ...
  const attentionItems = [
    {
      ...
      detail:
        `${data.attention.unreadDirectMessages} direct · ${data.attention.unreadGroupMessages} group`,
...

    {
      ...
      detail:
        "Your threads without an accepted solution",
  ...
  return (
    <div>
      ...
      {/* TOP STATS */}
      <div className="grid gap-[var(--space-section-small)] md:grid-cols-3">
        {cards.map(
          ({
            label,
            value,
      ...
      <div
        className="
          ...
          grid
          items-start
          gap-x-[var(--space-section)]
          gap-y-[var(--space-section)]
